RSpec.describe Bigcommerce::BulkPricingRule do
  ...
  describe '.count' do
    it 'should hit the correct path' do
      expect(@bulk_pricing_rule).to receive(:get).with('v2/products/1/discount_rules/count', {})
  ...
  describe '.count_all' do
    it 'should hit the correct path' do
      expect(@bulk_pricing_rule).to receive(:get).with('v2/products/discount_rules/count', {})
