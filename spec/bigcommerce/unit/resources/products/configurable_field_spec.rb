RSpec.describe Bigcommerce::ConfigurableField do
  ...
  describe '.count' do
    it 'should hit the correct path' do
      expect(@configurable_field).to receive(:get).with('v2/products/1/configurable_fields/count', {})
  ...
  describe '.count_all' do
    it 'should hit the correct path' do
      expect(@configurable_field).to receive(:get).with('v2/products/configurable_fields/count', {})
