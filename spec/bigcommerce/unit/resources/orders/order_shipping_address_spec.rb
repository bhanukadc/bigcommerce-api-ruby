RSpec.describe Bigcommerce::OrderShippingAddress do
  ...
  describe '.count' do
    it 'should hit the correct path' do
      expect(@shipping_address).to receive(:get).with('v2/orders/1/shipping_addresses/count', {})
  ...
  describe '.count_all' do
    it 'should hit the correct path' do
      expect(@shipping_address).to receive(:get).with('v2/orders/shipping_addresses/count', {})
